...
class panels_layouts_ui extends ctools_export_ui
{
    ...
    $form['preview']['button']['#submit'] = ['panels_edit_display_form_preview'];
    }
    ...
    switch ($form_state['values']['order']) {
      ...
      case 'storage':
        ...
        $this->rows[$item->name] = [
      'data' => [
        ['data' => check_plain($type), 'class' => 'ctools-export-ui-type'],
