...
class stylizer_ui extends ctools_export_ui
{
    ...
    public function list_form(&$form, &$form_state)
    {
      ...
      '#default_value' => 'all',
      '#weight'        => -10,
      '#attributes'    => ['class' => 'ctools-auto-submit'],
    ];
    ...
    switch ($form_state['values']['order']) {
      ...
      case 'storage':
        ...
        $this->rows[$item->name] = [
      'data' => [
        ['data' => $type, 'class' => 'ctools-export-ui-type'],
        ['data' => check_plain($item->name), 'class' => 'ctools-export-ui-name'],
        ['data' => check_plain($item->admin_title), 'class' => 'ctools-export-ui-title'],
        ['data' => check_plain($this->style_plugin['title']), 'class' => 'ctools-export-ui-base'],
        ['data' => check_plain($item->type), 'class' => 'ctools-export-ui-storage'],
