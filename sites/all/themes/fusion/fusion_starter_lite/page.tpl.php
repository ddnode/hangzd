...
<body id="<?php echo $body_id; ?>" class="<?php echo $body_classes; ?>">
  <div id="page" class="page">
    ...
    <div id="header-group" class="header-group row clearfix <?php echo $grid_width; ?>">
    ...
    <div id="main" class="main row clearfix <?php echo $grid_width; ?>">
      <?php if ($sidebar_first): ?>
      <div id="sidebar-first" class="sidebar-first row nested <?php echo $sidebar_first_width; ?>">
      ...
      <div id="main-group" class="main-group row nested <?php echo $main_group_width; ?>">
        ...
        <?php if ($sidebar_last): ?>
        <div id="sidebar-last" class="sidebar-last row nested <?php echo $sidebar_last_width; ?>">
          <?php echo $sidebar_last; ?>
        </div><!-- /sidebar-last -->
        <?php endif; ?>
      </div><!-- /main-group -->
    </div><!-- /main -->
    ...
    <?php if ($footer): ?>
    <div id="footer" class="footer row <?php echo $grid_width; ?>">
      <?php echo $footer; ?>
    </div><!-- /footer -->
    <?php endif; ?>
