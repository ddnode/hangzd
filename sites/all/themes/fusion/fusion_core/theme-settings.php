...
function fusion_core_initialize_theme_settings($theme_name)
{
    ...
    if (isset($theme_settings['rebuild_registry']) && $theme_settings['rebuild_registry'] == 1 && !$registry_rebuilt) {
        ...
        drupal_set_message(t('Theme registry rebuild completed. <a href="!link">Turn off</a> this feature for production websites.', ['!link' => url('admin/build/themes/settings/'.$GLOBALS['theme'])]), 'warning');
    ...
    $info_theme_settings = ($theme_name && isset($theme_data[$theme_name]->info['settings'])) ? $theme_data[$theme_name]->info['settings'] : [];
...
function phptemplate_settings($saved_settings)
{
  ...
  // General Settings
  $form['tnt_container']['general_settings'] = [
    '#type'        => 'fieldset',
  ...
  // Grid settings
  $form['tnt_container']['general_settings']['theme_grid_config'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Layout'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ...
  $grid_options = [];
    ...
    $form['tnt_container']['general_settings']['theme_grid_config']['theme_grid'] = [
    '#type'          => 'radios',
  ...
  // Fluid grid width
  $form['tnt_container']['general_settings']['theme_grid_config']['fluid_grid_width'] = [
    '#type'          => 'select',
  ...
  // Sidebar layout
  $form['tnt_container']['general_settings']['theme_grid_config']['sidebar_layout'] = [
    '#type'          => 'radios',
  ...
  // Sidebar first width
  $form['tnt_container']['general_settings']['theme_grid_config']['sidebar_first_width'] = [
    '#type'          => 'select',
  ...
  // Sidebar last width
  $form['tnt_container']['general_settings']['theme_grid_config']['sidebar_last_width'] = [
    '#type'          => 'select',
  ...
  // Theme fonts
  $form['tnt_container']['general_settings']['theme_font_config'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Typography'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ...
  $form['tnt_container']['general_settings']['theme_font_config']['theme_font_config_font'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Font family'),
    '#collapsible' => true,
    '#collapsed'   => true,
   ];
    $form['tnt_container']['general_settings']['theme_font_config']['theme_font_config_font']['theme_font'] = [
    '#type'          => 'radios',
  ...
  // Font size settings
  $form['tnt_container']['general_settings']['theme_font_config']['theme_font_config_size'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Font size'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ];
    $form['tnt_container']['general_settings']['theme_font_config']['theme_font_config_size']['theme_font_size'] = [
    '#type'          => 'radios',
  ...
  // Navigation
  $form['tnt_container']['general_settings']['navigation'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Navigation'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ...
  $form['tnt_container']['general_settings']['navigation']['primary_menu'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Primary Menu'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ];
    $form['tnt_container']['general_settings']['navigation']['primary_menu']['primary_menu_dropdown'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Enable primary menu as dropdown'),
    '#default_value' => $settings['primary_menu_dropdown'],
  ];
  // Breadcrumb
  $form['tnt_container']['general_settings']['navigation']['breadcrumb'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Breadcrumb'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ];
    $form['tnt_container']['general_settings']['navigation']['breadcrumb']['breadcrumb_display'] = [
    '#type'          => 'checkbox',
  ...
  if (module_exists('search')) {
      $form['tnt_container']['general_settings']['search_container'] = [
      '#type'        => 'fieldset',
      ...
      $form['tnt_container']['general_settings']['search_container']['search_results']['search_snippet'] = [
      '#type'          => 'checkbox',
      '#title'         => t('Display text snippet'),
      '#default_value' => $settings['search_snippet'],
    ];
      $form['tnt_container']['general_settings']['search_container']['search_results']['search_info_type'] = [
      '#type'          => 'checkbox',
      '#title'         => t('Display content type'),
      '#default_value' => $settings['search_info_type'],
    ];
      $form['tnt_container']['general_settings']['search_container']['search_results']['search_info_user'] = [
      '#type'          => 'checkbox',
      '#title'         => t('Display author name'),
      '#default_value' => $settings['search_info_user'],
    ];
      $form['tnt_container']['general_settings']['search_container']['search_results']['search_info_date'] = [
      '#type'          => 'checkbox',
      '#title'         => t('Display posted date'),
      '#default_value' => $settings['search_info_date'],
    ];
      $form['tnt_container']['general_settings']['search_container']['search_results']['search_info_comment'] = [
      '#type'          => 'checkbox',
      '#title'         => t('Display comment count'),
      '#default_value' => $settings['search_info_comment'],
    ];
      $form['tnt_container']['general_settings']['search_container']['search_results']['search_info_upload'] = [
      '#type'          => 'checkbox',
  ...
  // Username
  $form['tnt_container']['general_settings']['username'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Username'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ];
    $form['tnt_container']['general_settings']['username']['user_notverified_display'] = [
    '#type'          => 'checkbox',
  ...
  // Admin settings
  $form['tnt_container']['admin_settings'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Administrator settings'),
    '#collapsible' => true,
    '#collapsed'   => true,
  ];
    $form['tnt_container']['admin_settings']['block_config_link'] = [
    '#type'          => 'checkbox',
    ...
    $form['tnt_container']['admin_settings']['grid_mask'] = [
    '#type'          => 'checkbox',
  ...
  // Developer settings
  $form['tnt_container']['themedev'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Developer settings'),
    '#collapsible' => true,
    '#collapsed'   => $settings['rebuild_registry'] ? false : true,
  ];
    $form['tnt_container']['themedev']['rebuild_registry'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry for every page.'),
    '#default_value' => $settings['rebuild_registry'],
    '#description'   => t('This setting is useful while developing themes (see <a href="!link">rebuilding the theme registry</a>). However, it <strong>significantly degrades performance</strong> and should be turned off for any production website.', ['!link' => 'http://drupal.org/node/173880#theme-registry']),
  ];
    $form['tnt_container']['themedev']['fix_css_limit'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Avoid IE stylesheet limit.'),
    '#default_value' => $settings['fix_css_limit'],
    '#description'   => t('This setting groups css files so Internet Explorer can see more than 30 of them. This is useful when you cannot use aggregation (e.g., when developing or using private file downloads). But because it degrades performance and can load files out of order, CSS aggregation (<a href="!link">Optimize CSS files</a>) is <strong>strongly</strong> recommended instead for any production website.', ['!link' => $base_url.'/admin/settings/performance']),
  ];
