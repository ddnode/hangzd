...
<div id="header-wrapper">
        <div id="header-first">
          <?php if ($logo): ?> 
          <div class="logo">
            <a href="<?php echo $base_path ?>" title="<?php echo t('Home') ?>"><img src="<?php echo $logo ?>" alt="<?php echo t('Home') ?>" height="50"/></a>
          </div>
          <?php endif; ?>
        </div><!-- /header-first -->
    ...
    echo '<li><a href="'.url('user/register').'">'.t('Register').'</a></li>';
} ?></ul>
	  <?php echo $feed_icons; ?>
  </div>
...
<?php if ($left): ?>
		...
		<?php endif; ?>
<div id="content">
			<?php if ($mission) : ?><div id="mission-db"><?php echo $mission; ?></div><?php endif; ?>
