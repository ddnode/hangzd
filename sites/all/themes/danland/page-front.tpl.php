...
<div id="header-wrapper">
	  ...
	  <?php if ($site_name) : ?><h1 class="logo-name"><a href="<?php echo $front_page; ?>" title="<?php echo t('Home'); ?>"><?php echo $site_name; ?></a></h1><?php endif; ?>
...
<div id="mission"><?php echo $mission; ?></div></div><?php endif; ?>
<div class="slideshow">
<img src="<?php echo $base_path.$directory; ?>/images/slideshows/banner1.jpg" width="950" height="330" alt="slideshow 1"/>
<img src="<?php echo $base_path.$directory; ?>/images/slideshows/noon.jpg" width="950" height="330" alt="slideshow 2"/>
<img src="<?php echo $base_path.$directory; ?>/images/slideshows/snow.jpg" width="950" height="330" alt="slideshow 3"/>
</div>
</div>
</div>
