...
<?php if ($prev || $next): ?>
  <div class="forum-topic-navigation clear-block">
    <?php if ($prev): ?>
      <a href="<?php echo $prev_url; ?>" class="topic-previous" title="<?php echo t('Go to previous forum topic') ?>">‹ <?php echo $prev_title ?></a>
    <?php endif; ?>
    <?php if ($next): ?>
      <a href="<?php echo $next_url; ?>" class="topic-next" title="<?php echo t('Go to next forum topic') ?>"><?php echo $next_title ?> ›</a>
    <?php endif; ?>
  </div>
<?php endif; ?>
